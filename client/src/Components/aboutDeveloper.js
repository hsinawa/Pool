...
import awanish from "../Static/am.png";
    ...
    <div  >
      ...
      <div className="grid">
        ...
        <p>
          ...
          <p style={{width:'80%', marginLeft:'auto', marginRight:'auto', color:'#808080', textAlign:'center'}} > This Entire Application is developed entirely by me. Here's how to get in touch with me. </p>
          <br />
      ...
      <Grid item xs={2} md={2}>
        ...
        <Grid item xs={2} md={2}>
          <p title="Twitter">
            <a
              href={`https://twitter.com/Awanish92375091`}
              target="_blank"
              style={{ color: "black", cursor: "pointer" }}
            >
              <TwitterIcon
